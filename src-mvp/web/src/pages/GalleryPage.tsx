...
function extractGalleryImagePath(folder: FileNode): string | null {
    ...
    const firstImage = galleryFolder.children.find(
        (child) => child.category === 'image',
    ) as FileNode | undefined;
...
export const GalleryPage: React.FC = () => {
    ...
    const [folderTree, setFolderTree] = useState<FileNode | undefined>(
        undefined,
    );
