import { ElementHandle, expect, JSHandle, type Page, test } from '@playwright/test'
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function checkTodosInLocalStorage(page: Page, title: string): Promise<ElementHandle<any>> {
